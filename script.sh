...
apt_source_path="/etc/apt/sources.list.d/Docker_cs.list"
apt_config_url="https://e89f398318712242811b39644938211d7d6809dbef3eaa77:@packagecloud.io/install/repositories/Docker/cs/config_file.list?os=${os}&dist=${dist}&name=${host}&source
=script"
